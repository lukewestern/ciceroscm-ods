...
csmsp = groups["CFCs"]+groups["HCFCs"]+groups["Solvents"]+groups["Halons"]+groups["HFCs"]+groups["PFCs"]+groups["Other"]+groups["CH3Br"]
...
ds.attrs["title"] = "Forcing Data of halocarbons and other gases"
ds.attrs["description"] = "This dataset contains ERFs derived for halocarbons using an adaptation of the CICERO-SCM."
...
ds.to_netcdf(f"/user/home/lw13938/work/ciceroscm/RF_sensitivity/ensemble/outputs/ensemble_halocarbons_{fileindicator}.nc")