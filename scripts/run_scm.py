...
cscm = CICEROSCM(
    {
        ...
        "rf_volc_data":pd.read_csv("/div/qbo/utrics/RadiativeForcing/RFforSCM/volcanic_erf_ar6_TEST.txt", header=None, skiprows=1, index_col=0),
        "rf_luc_data":pd.read_csv("/div/qbo/utrics/RadiativeForcing/RFforSCM/land_use_erf_ar6.txt", header=None, skiprows=1, index_col=0)
     },
)
